...
if __name__ == "__main__":
    ...
    try:
        # build domain model
        domain_builder = DomainBuilderNQueens(8, random_seed=45)
        cotwin_builder = CotwinBuilderNQueens(scorer_name="greynet")
        ...
        agent = TabuSearch(neighbours_count=1, tabu_entity_rate=0.0, 
