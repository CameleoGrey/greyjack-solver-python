...
if __name__ == "__main__":
    ...
    #termination_strategy = TimeSpentLimit(time_seconds_limit=300)
    ...
    agent = TabuSearch(neighbours_count=128, tabu_entity_rate=0.8, 
                       ...
                       migration_frequency=999999, compare_to_global_frequency=10, termination_strategy=termination_strategy)
