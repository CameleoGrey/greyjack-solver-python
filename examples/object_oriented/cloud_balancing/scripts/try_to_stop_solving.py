...
if __name__ == "__main__":
    ...
    solver_thread.start()
    print("\nSolver started in a background thread. Running for 10 seconds...")

    time.sleep(10)

    print("\nSending stop signal to the solver...")
    solver.stop()

    solver_thread.join()
    print("Solver thread has terminated gracefully.")

    solution = solver.global_top_solution
