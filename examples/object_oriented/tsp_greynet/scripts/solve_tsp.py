...
from examples.object_oriented.tsp_greynet.persistence import DomainBuilder
from examples.object_oriented.tsp_greynet.persistence import CotwinBuilder
...
if __name__ == "__main__":
    ...
    termination_strategy = TimeSpentLimit(time_seconds_limit=2)
