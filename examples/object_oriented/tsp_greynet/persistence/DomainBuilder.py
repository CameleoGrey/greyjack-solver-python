...
from examples.object_oriented.tsp_greynet.domain.TravelSchedule import TravelSchedule
from examples.object_oriented.tsp_greynet.domain.Vehicle import Vehicle
from examples.object_oriented.tsp_greynet.domain.Location import Location
...
class DomainBuilder(DomainBuilderBase):
    ...
    def build_from_solution(self, solution, initial_domain=None):
        ...
        # TODO: write correct logic to extract path (no need before starting work on chained variables)
        raise Exception("TODO: write correct logic to extract path (no need before starting work on chained variables)")
        ...
        def compute_distance_matrix(latitudes, longitudes, n_locations):
            ...
            for i in range(n_locations):
                for j in range(n_locations):
                    ...
                    distance_matrix[i][j] = round(distance_from_to, 4)
